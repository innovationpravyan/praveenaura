...
class PaymentAndCheckout extends StatefulWidget {
  final Map<String, dynamic>? bookingData;

  const PaymentAndCheckout({super.key, this.bookingData});

  @override
  State<PaymentAndCheckout> createState() => _PaymentAndCheckoutState();
}

class _PaymentAndCheckoutState extends State<PaymentAndCheckout> {
